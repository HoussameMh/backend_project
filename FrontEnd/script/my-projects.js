            ...
            grid.innerHTML = projects.map(project => {
                ...
                <div class="project-card">
                    <div class="project-info">
                        ...
                        <div class="project-stats">
                            <div class="stat">
                                ...
                                <div class="stat-label">of ${project.goalAmount} DH</div>
                            </div>
                            <div class="stat">
                    ...
                    <div class="project-actions">
                        <a href="project-details.html?id=${project._id}" class="btn1 btn-primary1 btn-small">
                            <i class="ri-eye-line"></i> View
                        </a>
                        <button class="btn1 btn-success1 btn-small" onclick="openUpdateModal('${project._id}')">
                            <i class="ri-newspaper-line"></i> Post Update
                        </button>
                        <a href="edit-project.html?id=${project._id}" class="btn1 btn-secondary1 btn-small">
                            <i class="ri-edit-line"></i> Edit
                        </a>
                        <button class="btn1 btn-danger btn-small" onclick="deleteProject('${project._id}')">
